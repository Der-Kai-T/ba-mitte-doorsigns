...
//Cutting Lines
    ...
    $pdf->Cell($box_width, 10 * $mm_per_pt, utf8_decode("Dazu das Dokument in einem PDF-Programm (nicht im Browser) öffnen, z.B. Adobe Acrobat oder PDF24 um die Option im Drucken-Dialog zu sehen "), 0, 0, "C");
